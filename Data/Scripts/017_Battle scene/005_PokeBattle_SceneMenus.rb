...
class FightMenuDisplay < BattleMenuBase
  ...
  PP_COLORS = [
     ...
     Color.new(0,0,0),Color.new(248,248,248)       # Black, more than 1/2 of total PP
  ]
  ...
  def refreshButtonNames
    ...
    moves.each_with_index do |m,i|
      ...
      y = button.y-self.y+8
   moveNameBase =  Color.new(48,48,48) 
      moveNameShadow = Color.new(180,180,180)
      textPos.push([m.name,x,y,2,moveNameBase,moveNameShadow])
    end
