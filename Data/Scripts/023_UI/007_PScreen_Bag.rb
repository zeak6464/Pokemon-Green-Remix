...
class PokemonBag_Scene
  ...
  def pbStartScene(bag,choosing=false,filterproc=nil,resetpocket=true)
    ...
    @sprites["itemicon"] = ItemIconSprite.new(95,76,-1,@viewport)
    @sprites["itemicon"].zoom_x = 2 
    @sprites["itemicon"].zoom_y = 2
  ...
  def pbRefresh
    ...
    # Set the bag sprite
    fbagexists = pbResolveBitmap(sprintf("Graphics/Pictures/Bag/bag_1"))
    if $Trainer.female? && fbagexists
      @sprites["bagsprite"].setBitmap("Graphics/Pictures/Bag/bag_1")
    else
      @sprites["bagsprite"].setBitmap("Graphics/Pictures/Bag/bag_1")
    end
...
class PokemonBagScreen
  ...
  def pbStartScreen
    ...
    loop do
      ...
      commands[cmdDebug = commands.length]      = _INTL("Debug") if $PokemonSystem.modes == 1
