class PokemonSystem
  ...
  attr_accessor :randm
  attr_accessor :randp
  attr_accessor :randevo
  attr_accessor :overworld
  attr_accessor :modes
  attr_accessor :switchtrainer
  attr_writer   :OWP
  ...
  def randomizer;  return @randomizer || 0;  end
  def delta;       return @delta || 0;       end
  def randm;       return @randm || 0;       end
  def randp;       return @randp || 0;       end
  def randevo;     return @randevo || 0;     end  
  def overworld;   return @overworld || 0;   end  
  def modes;       return @modes || 0;       end  
  def switchtrainer; return @switchtrainer || 0; end  
  def OWP;         return @OWP || 0; end  
end
...
class PokemonOption_Scene
  ...
  def pbStartScene(inloadscreen=false)
    ...
    @PokemonOptions = [
       ...
       #Delta Pokemon 
       EnumOption.new (_INTL("Delta Mode"), [_INTL("Off"),_INTL("On")], 
          proc {$PokemonSystem.delta},
          proc {|value|
            $PokemonSystem.delta = value
          }
       ),
       #Random Pokemon encounters & trainers
       EnumOption.new (_INTL("Random Mode"), [_INTL("Off"),_INTL("On")],
          proc {$PokemonSystem.randm},
          proc {|value|
            $PokemonSystem.randm = value
          }
       ),
       #Random Pokemon Party
       EnumOption.new (_INTL("Random Party Mode"), [_INTL("Off"),_INTL("On")],
          proc {$PokemonSystem.randp},
          proc {|value|
            $PokemonSystem.randp = value
          }
       ),
       #Switch Trainer Party
       EnumOption.new (_INTL("Switch Trainer Mode"), [_INTL("Off"),_INTL("On")],
          proc {$PokemonSystem.switchtrainer},
          proc {|value|
            $PokemonSystem.switchtrainer = value
          }
       ),
      #Random Pokemon Evo
       EnumOption.new (_INTL("Random Evo Mode"), [_INTL("Off"),_INTL("On")],
          proc {$PokemonSystem.randevo},
          proc {|value|
            $PokemonSystem.randevo = value
          }
       ),
       #Pokemon Encounters
         EnumOption.new (_INTL("Encounters"), [_INTL("OW"),_INTL("Inst"),_INTL("Both")], 
          proc {$PokemonSystem.overworld},
          proc {|value|
            $PokemonSystem.overworld = value
          if value == 0
              $PokemonSystem.OWP = 0
          elsif value == 1 
              $PokemonSystem.OWP = 100
          elsif value == 2
              $PokemonSystem.OWP = 50
            end
          }
       ),
       #Streamer Mode
