...
# Controles 
MenuHandlers.addEntry(:ENCOUNTERS,_INTL("Encounters"),"menuEncounters",proc{|menu|
  pbFadeOutIn(99999) { 
    pbEncounterListUI
  }
},proc{ return true })
...
# Controles 
MenuHandlers.addEntry(:CONTROLES,_INTL("Controls"),"menuControls",proc{|menu|
...
},proc{ return $PokemonSystem.modes })